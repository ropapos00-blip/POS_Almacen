-- 16_restore_wholesale_create_invoice_rpc.sql
-- Restaura la version moderna de create_wholesale_invoice_transaction
-- (usa reference_id + quantity, controla stock y calcula vencimiento automatico a 30 dias).
