import { Bookmark, FileText, LayoutDashboard, LogOut, Menu, Package, ReceiptText, ShoppingCart, Store, Users, Wallet, X } from 'lucide-react'
...
const storeNavItems = [
  ...
  { to: '/gastos', label: 'Gastos', icon: Wallet, roles: ['super_admin', 'admin'] },
